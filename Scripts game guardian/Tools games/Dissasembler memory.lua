...
_ = gg.choice(ElfInsideMem, nil, "Please select the library: ")
...
Elf			= GetLibInformation(TargetLib) --<< This is where it parses elf data >>--
...
-----------------------// print values//--------------------------
	...
	for _=2, #Elf.Sym do SymInfoValue[#SymInfoValue + 1] = "["..tostring(_).."]: "..Elf.Sym[_].st_size
...
if gg.alert("SUCCESSFULLY COMPLETED", "OK") == 1 then 
